...
export default function RegisterPage() {
  ...
  const getPasswordStrength = (pass: string) => {
    let score = 0;
    if (!pass) return { score, label: "", color: "transparent" };
    ...
    if (score <= 4) return { score, label: "Fair", color: "#f59e0b" }; // yellow
                ...
                {password && (
                  <div className="mt-2">
                    <div className="flex gap-1 mb-1" style={{ height: "4px" }}>
                      {[1, 2, 3, 4, 5].map((i) => (
                        <div 
                          ...
                          style={{ 
                            flex: 1, 
                            backgroundColor: i <= strength.score ? strength.color : "var(--card-border)",
                            borderRadius: "2px",
                    ...
                    <div className="flex justify-between items-center text-xs">
                      ...
                      <span className="text-secondary" style={{ fontSize: "0.7rem" }}>Requires 8+ chars, uppercase, lowercase, number, symbol</span>
                    </div>
                  </div>
                )}
              </div>
